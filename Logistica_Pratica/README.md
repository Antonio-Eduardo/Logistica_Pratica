...
Manipulação de Datas: Usei SimpleDateFormat pra transformar as Strings que eu recebi em objetos Date de verdade e depois formatar tudo bonitinho no relatório.
StringBuilder: Aprendi que usar System.out.println dentro de toString é pedir pra passar raiva, 
agora eu monto o relatório inteiro no StringBuilder e dou um único print no final. Um pequeno exemplo de como a saida ficou: 

------------------------
====DETALHES DA ENCOMENDA=====
Codigo de Rastreio: B0238D23

--- HISTÓRICO DE MOVIMENTAÇÃO ---

21/03/2026 07:23:47 - POSTAGEM: Seu objeto foi postado. 
(Cidade: Sao Paulo, Estado: Cajamar, Sigla: SP)

... (e por aí vai até a entrega)
...
a questão da impressão. Estou iniciando o modulo de polimorfismo e herança, pretendo continuar atualizando esse projeto para pratica. ficou assim